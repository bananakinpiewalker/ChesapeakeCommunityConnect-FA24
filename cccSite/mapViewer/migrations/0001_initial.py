# Generated by Django 4.2.6 on 2024-10-28 00:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.SmallIntegerField(choices=[(-1, 'denied'), (0, 'pending'), (1, 'visible')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('format', models.SmallIntegerField(choices=[(1, 'video'), (2, 'audio'), (0, 'image')], default=0)),
